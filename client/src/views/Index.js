...
export default function Index({ Widget }) {
        ...
        <div className="container mx-auto items-center flex flex-wrap">
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              ...
              Axis React - A beautiful extension for Tailwind CSS.
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-blueGray-500">
              Axis React is Free and Open Source. It does not change any of
                the CSS from{" "}
                <a
      ...
      <section className="mt-48 md:mt-40 pb-40 relative bg-blueGray-100">
                ...
                <div className="w-full md:w-6/12 px-4">
                  <div className="relative flex flex-col mt-4">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      Axis React comes with a huge number of Fully Coded CSS
                        components.
                      </p>
                    </div>
                  </div>
        ...
        <div className="justify-center text-center flex flex-wrap mt-24">
          <div className="w-full md:w-6/12 px-12 md:px-4">
            ...
            Axis React is a completly new product built using our past
